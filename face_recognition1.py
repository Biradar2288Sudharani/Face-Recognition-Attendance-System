...
class Face_Recognition:
    ...
    def mark_attendance(self, id, roll_no, name, dept):
        ...
        if not os.path.exists("Attendance Report"):
            os.makedirs("Attendance Report")

        file_path = "Attendance Report/sudha.csv"
    ...
    def face_recog(self):
        ...
        clf.read(r"C:\Users\lenovo\Desktop\Final Project\classifier.xml")
