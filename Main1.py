...
class F_R_S:
    def __init__(self,root):
        ...
        b1.place(x=230,y=70,width=200,height=200)
        ...
        b1_lbl.place(x=230,y=235,width=200,height=40)
        ...
        b1.place(x=590,y=70,width=200,height=200)
        ...
        b1_lbl.place(x=590,y=231,width=200,height=40)
        ...
        b1.place(x=950,y=70,width=200,height=200)
        ...
        b1_lbl.place(x=950,y=230,width=200,height=40)
        ...
        b1.place(x=230,y=300,width=200,height=200)
        ...
        b1_lbl.place(x=230,y=490,width=200,height=40)
        ...
        b1_lbl.place(x=950,y=490,width=200,height=40)
