...
class Student:
    def __init__(self,root):
        ...
        # Image One
        img=Image.open(r"C:\Users\lenovo\Desktop\Face_Recognisation_System\Images\s1.png")
        ...
        # Image Two
        img1=Image.open(r"C:\Users\lenovo\Desktop\Face_Recognisation_System\Images\s2.png")
        ...
        # Image Three
        img2=Image.open(r"C:\Users\lenovo\Desktop\Face_Recognisation_System\Images\s4.png")
        ...
        # Background Image
        img3=Image.open(r"C:\Users\lenovo\Desktop\Face_Recognisation_System\Images\bg1.png")
...
# ************************************* --> Left LABEL FRAME STARTED <-- **************************************************
        ...
        # Left Image 
        img_left=Image.open(r"C:\Users\lenovo\Desktop\Face_Recognisation_System\Images\left_image.png")
        ...
        save_btn=Button(btn_frame,text="Svae",command=self.add_data,width=16,font=("times new roman",13,"bold"),bg="blue",fg="white")  
...
# ************************************* --> RIGHT LABEL FRAME STARTED <-- **************************************************
        ...
        # Right Image
        img_right=Image.open(r"C:\Users\lenovo\Desktop\Face_Recognisation_System\Images\bg7.png")
...
# ****************************** MYSQL DataBase Connection Part Started ************************* 
    ...
    # ********************* Search Data Function Generating *************************************************
    def search_data(self):
        ...
        try:
            ...
            # Clean input and find the matching column
            search_key = self.var_com_search.get().strip()
            column = column_mapping.get(search_key)
            
            if not column:
                messagebox.showerror("Error", f"Invalid search column selected: {search_key}", parent=self.root)
                return
            ...
            # Construct a safe SQL query using parameterized statements
            query = f"SELECT * FROM student WHERE {column} LIKE %s"
            search_term = f"%{self.var_search.get().strip()}%"
            ...
            messagebox.showerror("Database Error", f"Database connection error: {e}", parent=self.root)
        except Exception as es:
            messagebox.showerror("Error", f"Due to: {str(es)}", parent=self.root)
