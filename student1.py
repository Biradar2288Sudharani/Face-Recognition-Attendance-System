    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department"or self.var_std_name.get() == "" or self.var_std_id.get() == "": 
            ...
            try:
                ...
                face_classifier = cv2.CascadeClassifier(r"C:\\Users\\lenovo\\Desktop\\Final Project\\haarcascade_frontalface_default.xml")
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path=r"C:\Users\lenovo\Desktop\Final Project\data\."+str(id)+"."+str(img_id)+".jpg"
